package com.zyhao.openec.common.config;
...
public class QuartzConfig {
	...
	public Properties quartzProperties() throws IOException {
		...
		prop.put("org.quartz.dataSource.quartzDataSource.URL", "jdbc:mysql://db.openec.zyhao.com:3306/quartzdb");
		prop.put("org.quartz.dataSource.quartzDataSource.user", "root");
		prop.put("org.quartz.dataSource.quartzDataSource.password", "3g2win.com");
